...
const Home = () => {
  ...
  return (
    <div className="h-screen flex flex-col justify-center items-center bg-customBlue text-white" id='home'>
      ...
      <div className="sm:px-10 lg:px-36 xl:px-40 mt-3 px-4 text-center">
        ...
        <p className="mt-4">Para visualizar los posts haga click en el Siguiente botón.</p>
        <button onClick={goToPosts} className="bg-white text-customBlue px-6 py-3 mt-8 rounded-full hover:bg-blue-300 transition duration-300">
          Ir a Posts
        </button>
      </div>
    </div>
