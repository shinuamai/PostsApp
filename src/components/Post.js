                    ...
                    {posts?.map((post) => (
                        <tr key={post.id} className="space-y-4">
                          <td className="bg-customBlue text-center border-customBlue rounded-l-lg w-1/12">
                            <button className="text-white" onClick={() => onOpenEditModal(post)}>
                          ...
                          <td className="bg-customBlue border-customBlue  text-left w-2/3 px-5">
                            <h1 className="font-medium text-base md:text-lg lg:text-xl py-1">{post.title}</h1>
                            <h2 className="font-thin text-xs md:text-sm lg:text-base">{post.body}</h2>
                          </td>
                          <td className="text-center bg-customBlue border-customBlue rounded-r-lg w-1/12">
                            <button className="text-white"  onClick={() => onOpenDeleteModal(post)}>
